...
function ResultScreen({ score, totalQuestions, onRestart, onBackToMenu, onBackToQuizSelection, soundEnabled }) {
      ...
      <div className={`${styles.card} ${getResultLevelClass()}`}>
        ...
        <div className={styles.buttons}>
          ...
          <button
            ...
            onClick={() => handleButtonClick(onBackToQuizSelection ?? onBackToMenu)}
          >
